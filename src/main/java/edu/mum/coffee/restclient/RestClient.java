...
//updatePerson();
	...
	private static void getProduct(){
		RestTemplate restTemplate = new RestTemplate();
		Product prod = restTemplate.getForObject(SERVER_URI+"products/179", Product.class);
	...
	private static void createProduct() {
		...
		prod.setProductName("Strawberry Frappe");
		prod.setDescription("Our latest in a collection of varied tasty coolsers");
		prod.setPrice(4.59);
		prod.setProductType(ProductType.LUNCH);
		Product response = restTemplate.postForObject(SERVER_URI+"products/new", prod, Product.class);
